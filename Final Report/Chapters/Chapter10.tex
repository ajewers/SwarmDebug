...
This chapter has described the methods used to test the application software and verify its correct operation. The results of these tests were presented and the resulting fixes described. The results of the verification and validation testing were used to verify that the software satisfied the functional specification defined in section \ref{FunctionalSpecification}. The use of unit-test style code build into the application for testing the data model was also discussed.