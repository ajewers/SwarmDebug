...
- All located information easily and quickly
- All located settings ofr network, vis, camera, logging quickly
- Current state not on state tab [1, 3, 6]
- Visualiser settings not related to selected robot [1, 2, 5]
- Double click to edit visualiser settings not clear [1, 2, 3, 5, 6]; Suggestions included drop down, right click or expandable list with sub items for each visualisation type
- IR mode toggle unclear, proximity not named, should be dropdown: [3]

Debugging:
- Used visualiser settings to customise visible information
- Used state tab to identify lack of IDLE state in behaviour: [1, 2, 4, 5, 6]
- Used IR tab to look at specific values: [1, 2, 4, 5, 6]

Comments:
P1	- Useful to see data in real time
	- System would be helpful based on robotics experience
	
P2	- Useful to have IR
	- Still requires knowledge of the robots and the code (flaw with evaluation method)
	
P3	- IR data v. useful
	- Questioned how debugging could be achieved without this kind of system
	
P4	- Sensor data reporting useful in this scenario, all data reporting potentially useful
	- Noted the portability of the system, mentioned other potential platforms to use it with
	
P5 	- n/a

P6 	- Commented on immediate applicability to their current work
	- Noted a number of scenarios each feature would be useful in
