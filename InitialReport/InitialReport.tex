...
\section{Project Objectives and Specification} \label{Objectives}
...
\bibitem{EPuck} Mondada, F., Bonani, M., Raemy, X., Pugh, J., Cianci, C., Klaptocz, A., Magnenat, S., Zufferey, J.-C., Floreano, D. and Martinoli, A. (2009) The e-puck, a Robot Designed for Education in Engineering. Proceedings of the 9th Conference on Autonomous Robot Systems and Competitions, 1(1) pp. 59-65.
...
\bibitem{Recruiting} Distributed strategy for robots recruitment in swarm-based systems Luneque Del Rio de Souza e Silva Junior
...
\bibitem{HumanSwarmInteractionSurvey} A. Kolling, P. Walker, N. Chakraborty, K. Sycara and M. Lewis, "Human Interaction With Robot Swarms: A Survey," in IEEE Transactions on Human-Machine Systems, vol. 46, no. 1, pp. 9-26, Feb. 2016. doi: 10.1109/THMS.2015.2480801
\bibitem{DesginingInterfaces} Designing interfaces for multi-user, multi-robot systems, A. Rule, J. Forlizzi, Proceedings HRI '12 Proceedings of the seventh annual ACM/IEEE international conference on Human-Robot Interaction Pages 97-104 
\bibitem{InterfaceColour} Christ, R.E. (1984) Research for evaluating visual display codes: An emphasis on colour coding. In Easterby, R. and Zwaga, H. eds. Information design: The design and evaluation of signs and printed materials, John Wiley and Sons, 209-228.
\bibitem{InterfaceText} Carney, C., Campbell, J.L. and Mitchell, E.A. (1998) In vehicle display icons and other information elements: Literature review, Federal Highway Administration.
\bibitem{AugmentedRealityDebuggingSystem} An Augmented Reality Debugging System for Mobile Robot Software Engineers T. H. J. Collett B. A. MacDonald
\bibitem{Player} The Player/Stage Project: Tools for Multi-Robot and Distributed Sensor Systems
\bibitem{ARForPlayer} Augmented Reality Visualisation for Player T. H. J. Collett and B. A. MacDonald
...
\bibitem{NASAApproach} Recommended Approach to Software Development National Aeronautics and Space Administration 
\end{thebibliography}
